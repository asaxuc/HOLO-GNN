...
class TUDataset(InMemoryDataset):
    ...
    def __init__(self, root: str, name: str,
        ...
        if False: #not (self.name == 'MUTAG' or self.name == 'PTC_MR' or self.name == 'DD' or self.name == 'PROTEINS' or self.name == 'NCI1' or self.name == 'NCI109' or self.name == 'DHFR'):
        ...
        self.data.x = torch.ones((self.data.num_nodes, 1))
